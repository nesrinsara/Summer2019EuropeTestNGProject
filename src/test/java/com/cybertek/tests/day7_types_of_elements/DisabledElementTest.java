...
public class DisabledElementTest {
    ...
    public void test1(){
        ...
        Assert.assertFalse(greenRadioButton.isEnabled(),"verify green is disabled");
    }
    @Test
    public void test2(){
        WebDriver driver= WebDriverFactory.getDriver("chrome");
        ...
        WebElement inputBox=driver.findElement(By.cssSelector("#input-example>input"));//or (//input)[2]
