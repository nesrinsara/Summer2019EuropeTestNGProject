...
public class WebTableExample {
    ...
    public void printTable() {
        ...
        //verify jsmith@gmail.com is in the table
        Assert.assertTrue(wholeTable.contains("jsmith@gmail.com"), "verify table contains email");
    ...
    public void printTableSize() {
        ...
        System.out.println("number of rows:" + allRowsWithHeader.size());
...
//        System.out.println(secondRow.getText());
    ...
    public void getSpecificCellByIndex(){
        ...
        //Create a method that accepts row and col number, ad return cell as awebelement
